...
//   - getCita(citaId) → reemplaza CITA_MOCK
...
export default function DetalleCita() {
  ...
  // TODO: llamar a cancelarCita(cita.id) de api.ts cuando PHP esté listo
  ...
  // Envía la solicitud de reagendar
  // TODO: llamar a solicitarCita({ fechaPreferida: fechaNueva, horaPreferida: horaNueva, motivo: motivoReagendar })
  // PHP creará un nuevo appointment con estado "pendiente" y cancelará el actual
  ...
  return (
    <>
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-2xl mx-auto p-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 mb-5">
            ...
            {cita.feedback ? (
              // Si hay feedback, lo muestra con un estilo destacado
              ...
              // Si no hay feedback, muestra un mensaje según el estado
          ...
          {/* ===========================
              ACCIONES DE LA CITA
              Solo visibles si la cita es confirmada o pendiente.
              Cancelada y completada no tienen acciones disponibles.
              =========================== */}
          ...
          {/* Mensaje si la cita ya fue cancelada */}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm mx-4">
            ...
            <p className="text-xs text-slate-400 text-center mb-6">
              Esta acción no se puede deshacer. Si deseas reagendarla puedes hacerlo después.
            </p>
      ...
      {/* ===========================
          ...
          El paciente propone nueva fecha/hora.
          PHP crea una nueva solicitud con estado "pendiente"
          y el psicólogo la confirma.
          =========================== */}
      {modalReagendar && (
        <div
          className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50"
          onClick={() => {
            if (!reagendado) setModalReagendar(false)
          }}
        >
          <div
          ...
          >
            {/* Pantalla de éxito al reagendar */}
            {reagendado ? (
              <div className="text-center py-4">
                ...
                <p className="text-sm text-slate-500 mb-1">
                  ...
                  <span className="font-medium text-dark">
                    {new Date(fechaNueva + "T12:00:00").toLocaleDateString("es-MX", {
                      weekday: "long", day: "numeric", month: "long"
                    })}
                  </span>{" "}
                  a las <span className="font-medium text-dark">{horaNueva} hrs</span> fue enviada.
                </p>
